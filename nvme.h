...
enum nvme_ctrl_type {
	NVME_CTRL_TYPE_NOT_REPORTED = 0,
	NVME_CTRL_TYPE_IO	= 1,		/* I/O controller */
	NVME_CTRL_TYPE_DISC	= 2,		/* Discovery controller */
	NVME_CTRL_TYPE_ADMIN	= 3,		/* Administrative controller */
};
...
struct nvme_id_power_state {
	__u16			max_power;	/* centiwatts */
	__u8			rsvd2;
	__u8			flags;
	__u32			entry_lat;	/* microseconds */
	__u32			exit_lat;	/* microseconds */
	__u8			read_tput;
	__u8			read_lat;
	__u8			write_tput;
	__u8			write_lat;
